...
const AVATAR_PRESETS = {
  ...
  other: [
    'https://api.dicebear.com/9.x/shapes/svg?seed=Sky',
    'https://api.dicebear.com/9.x/shapes/svg?seed=River',
    'https://api.dicebear.com/9.x/shapes/svg?seed=Star',
    'https://api.dicebear.com/9.x/shapes/svg?seed=Moon',
  ],
};
