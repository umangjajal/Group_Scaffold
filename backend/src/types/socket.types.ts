...
export interface ServerToClientEvents {
    ...
    'rtc:offer': (data: { from: string; fromName: string; roomId: string; sdp: RTCSessionDescriptionPayload }) => void;
    'rtc:answer': (data: { from: string; roomId: string; sdp: RTCSessionDescriptionPayload }) => void;
    'rtc:ice-candidate': (data: { from: string; roomId: string; candidate: RTCIceCandidatePayload }) => void;
...
export interface ClientToServerEvents {
    ...
    'rtc:ice-candidate': (data: { to: string; candidate: RTCIceCandidatePayload; roomId: string }) => void;
}
